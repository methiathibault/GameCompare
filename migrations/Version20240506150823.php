 ...
 */
final class Version20240506150823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD n_editors_id INT DEFAULT NULL, ADD release_date DATE NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game DROP n_editors_id, DROP release_date');
    }
}
